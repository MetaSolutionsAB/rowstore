...
/**
 * JUnit 5 extension that starts a RowStore test environment with regex queries disabled.
 *
 * In this mode, all query values are treated as literal strings - regex patterns
 * are not interpreted.
 *
 * Usage:
 * <pre>
 ...
 * @Tag("regex-disabled")
 * class MyRegexDisabledTest {
 *     // tests...
 * }
 * }
 * </pre>
 */
public class RegexDisabledExtension implements BeforeAllCallback, ExecutionCondition {

    private static final Logger log = LoggerFactory.getLogger(RegexDisabledExtension.class);
    ...
    public ConditionEvaluationResult evaluateExecutionCondition(ExtensionContext context) {
        ...
        if (!isDockerAvailable()) {
            return ConditionEvaluationResult.disabled(
                    "Docker is not available. RegexDisabledExtension tests require Docker.");
        }
