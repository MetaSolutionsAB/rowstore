...
class DatasetEncodingIT extends BaseIntegrationTest {
    ...
    @Test
    @Order(1)
    @DisplayName("TC-DATASET3-001: Dataset created from Windows-1252 CSV")
    void datasetCreated() {
        given()
                .spec(jsonSpec)
        .when()
    ...
    @Test
    @Order(5)
    @DisplayName("TC-DATASET3-005: Verify row count after append is 10")
    void verifyRowCountAfterAppend() {
        given()
                .spec(jsonSpec)
        .when()
                .get(infoUrl)
